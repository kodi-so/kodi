...
export type MeetingChatEventName =
...
export type MeetingChatEvent = MeetingProviderEventBase<'chat'> & {
  action: MeetingChatEventName
  message: {
    content: string
    to?: string | null
    sender?: MeetingParticipantIdentity | null
  }
}
